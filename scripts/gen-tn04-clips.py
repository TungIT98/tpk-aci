#!/usr/bin/env python3
"""Generate TN-04 video clips (5 clips) using Pexels video + gTTS + FFmpeg."""
...
script_path = SCRIPTS_DIR / "TN-04.json"
if not script_path.exists():
    print("[TN-04] ERROR: TN-04.json not found")
    sys.exit(1)
...
for clip in clips:
    ...
    try:
        ...
        if not videos:
            videos = search_pexels("ancient china fantasy martial arts epic")
