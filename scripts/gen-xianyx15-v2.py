#!/usr/bin/env python3
"""Generate XIANYX-15 Muc Than Ky Episode 3 - Pexels + gTTS + FFmpeg (v2 - re-encode concat fix)."""
...
TEMP = ROOT / "output" / "_temp_xianyx15_v2"
...
SHOT_QUERIES = [
    "graveyard fog moonless night ancient stones",
    "fog path mysterious woman standing moonlit",
    "woman face portrait dramatic dark mysterious",
    "ancient gold artifact dramatic light jewelry",
    "fog dark forest mysterious figure silhouette",
]

def log(*a): print("[XIANYX-15-v2]", *a)
...
# Step 2: Concat with RE-ENCODE (fix: not stream copy)
