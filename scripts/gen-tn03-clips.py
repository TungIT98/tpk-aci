#!/usr/bin/env python3
"""Generate TN-03 video clips (5 clips) using Pexels video + gTTS + FFmpeg."""
...
script_path = SCRIPTS_DIR / "TN-03.json"
if not script_path.exists():
    print("[TN-03] ERROR: TN-03.json not found")
    sys.exit(1)
...
for clip in clips:
    ...
    try:
        ...
        if not videos:
            videos = search_pexels("ancient china fantasy epic cinematic")
