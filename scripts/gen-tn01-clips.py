#!/usr/bin/env python3
"""Generate TN-01 video clips (5 clips) using Pexels video + gTTS + FFmpeg."""
...
script_path = SCRIPTS_DIR / "TN-01.json"
if not script_path.exists():
    print("[TN-01] ERROR: TN-01.json not found in scripts/pending/")
    sys.exit(1)
