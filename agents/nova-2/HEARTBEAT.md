# Nova 2 HEARTBEAT.md — Browser Operator - Professional Video
...
- [ ] Read `agents/nova-2/memory/` for recent notes if they exist
...
```bash
GET /api/companies/fe90b604-364f-480d-be10-6a529971db57/issues?assigneeAgentId=8e06e2ee-45d7-475d-b7b0-381bd5ed6490&status=todo,in_progress
```
...
3. [ ] Write daily note in `agents/nova-2/memory/YYYY-MM-DD.md` if needed
