#!/usr/bin/env python3
"""Generate XIANYX-10 video: Muc Than Ky Episode 2 - The Ink Spirit
...
TEMP = ROOT / "output" / "_temp_xianyx10"
...
SCRIPT_PATH = ROOT / "scripts" / "pending" / "xianxia" / "XIANYX-10.json"
OUTPUT_DIR = ROOT / "output_topic" / "videos"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
TEMP.mkdir(parents=True, exist_ok=True)
OUTPUT_FILE = OUTPUT_DIR / "XIANYX-10.mp4"
...
def minimax_tts(text, output_path):
    ...
    req = urllib.request.Request(
        ...
        data=json.dumps({"model": "speech-2.8-hd", "text": text, "speed": 1.0}).encode(),
        headers={
    ...
    try:
        with urllib.request.urlopen(req, timeout=30) as resp:
            ...
            # MiniMax returns audio_url or base64 audio
...
if OUTPUT_FILE.exists() and OUTPUT_FILE.stat().st_size > 100_000:
    ...
    # 5 shots - thematic Pexels searches for burial ground / ink spirit aesthetic
    searches = [
        # Shot 1: Ancient cemetery at night, moonless, foggy, eerie
        "ancient cemetery fog night grave moonless",
        # Shot 2: Dark shadows moving in fog, cemetery, eerie
        "dark shadows fog cemetery night eerie",
        # Shot 3: Ink or black liquid dark abstract close-up, mysterious
        "black ink liquid dark abstract close",
        # Shot 4: Dark ritual ancient, kneeling, candles, mysterious
        "dark ancient ritual candles mysterious",
        # Shot 5: Dark smile dramatic close-up, intense, mysterious
        "dark dramatic portrait intense mysterious",
    ]
    ...
    try:
        ...
        log("MiniMax failed, trying gTTS...")
