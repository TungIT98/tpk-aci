#!/usr/bin/env python3
"""Generate XIANYX-03 video: Pexels + gTTS + FFmpeg."""
...
TEMP = ROOT / "output" / "_temp_xianyx03"
PEXELS_KEY = "1OgVKQwZjQ1aVnixVZFFOE6FoGa9HmTysLOOfxOzfhgJtKiT04fWsaEa"
SCRIPT_PATH = ROOT / "scripts" / "pending" / "xianxia" / "XIANYX-03.json"
OUTPUT_DIR = ROOT / "output_topic" / "videos"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
TEMP.mkdir(parents=True, exist_ok=True)

OUTPUT_FILE = OUTPUT_DIR / "XIANYX-03.mp4"
...
if OUTPUT_FILE.exists() and OUTPUT_FILE.stat().st_size > 100_000:
    ...
    # 5 shots need 5 different Pexels clips
    searches = [
        # Shot 1: volcanic ash valley, dramatic landscape, young man crawling
        "volcanic ash landscape dramatic barren terrain",
        # Shot 2: betrayal close-up, dramatic lighting, tears
        "dramatic close-up dark lighting intense emotion",
        # Shot 3: person lying on back staring upward, dramatic sky
        "person lying ground looking up sky clouds",
        # Shot 4: fire ember glow, mysterious light in darkness
        "fire flame ember glow darkness mysterious",
        # Shot 5: person rising determined, screaming into sky, fire burst
        "dramatic fire flames burning intense energy",
    ]
    ...
    # gTTS - trim to max 500 chars per request
...
log("Script JSON updated with videoFile and status=produced")
