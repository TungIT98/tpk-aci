#!/usr/bin/env python3
"""Generate XIANYX-27: Dau Pha Thuong Khau Episode 6 - The Fire's Price
Pexels + gTTS + FFmpeg.
"""
...
TEMP = ROOT / "output" / "_temp_xianyx27"
PEXELS_KEY = "1OgVKQwZjQ1aVnixVZFFOE6FoGa9HmTysLOOfxOzfhgJtKiT04fWsaEa"
SCRIPT_PATH = ROOT / "scripts" / "pending" / "xianxia" / "XIANYX-27.json"
OUTPUT_DIR = ROOT / "output_topic" / "videos"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)
TEMP.mkdir(parents=True, exist_ok=True)
OUTPUT_FILE = OUTPUT_DIR / "XIANYX-27.mp4"
...
if OUTPUT_FILE.exists() and OUTPUT_FILE.stat().st_size > 100_000:
    ...
    # 5 shots matching Dau Pha Thuong Khau Episode 6: The Fire's Price
    # Shot 1: night village healing with flame, woman watching from doorway
    # Shot 2: flame screaming/supernatural darkness, dark figure emerging
    # Shot 3: man and woman kneeling face to face, tearful
    # Shot 4: white/gold light emerging, tears
    # Shot 5: dawn, man holding woman, flame erupting, peaceful aftermath
    searches = [
        "village night fire healing warm glow dark houses",
        "dark supernatural figure emerging darkness dramatic fire glow",
        "man woman kneeling face to face tears dramatic dark",
        "bright light emerging darkness golden white dramatic",
        "dawn breaking golden light peaceful aftermath fire warmth",
    ]
    ...
    # Concat all 5 clips (5 x 6s = 30s) - use re-encode to fix concat duration bug
    if len(clip_paths) == 1:
