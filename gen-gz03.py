#!/usr/bin/env python3
"""Generate GZ-03 video: Pexels + gTTS + FFmpeg."""
...
if OUTPUT_FILE.exists() and OUTPUT_FILE.stat().st_size > 100_000:
    ...
    searches = [
        "LinkedIn job search young professional phone notification",
        "person typing smartphone career opportunity success",
    ]
    ...
    for i, query in enumerate(searches):
        ...
        # Convert to portrait 1080x1920, trim to 2.5s
...
log("Script JSON updated with video_path and status=produced")
