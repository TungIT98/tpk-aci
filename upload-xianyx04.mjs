...
const videoPath = resolve(__dirname, 'output', 'xianxia', 'XIANYX-04', 'final.mp4');
const caption = 'In the great Azure Bamboo Valley, disciples came to ascend. But no one spoke of the ones who came to suffer 🦋 She freed a butterfly from a spider web — and they took her from him. 15 years the butterfly waited inside this jade. #xianxia #thanhvanmon #bluebutterfly #cultivation #ethereal #fantasy #dramatic #mysterious';

console.log('Video path:', videoPath);
console.log('Exists:', existsSync(videoPath));

// Browser-level connection using the current browser ID
